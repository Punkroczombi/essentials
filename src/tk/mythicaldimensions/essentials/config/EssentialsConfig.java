package tk.mythicaldimensions.essentials.config;
...
public final class EssentialsConfig {
	...
	public void loadConfig() {
		...
		configReloadedMessage = config.getString(CONFIG_RELOAD_KEY, "&F[&4Essentials Config Reloaded&F]");
	...
	public void setDefaults() {
		...
		config.addDefault(CONFIG_RELOAD_KEY, "&F[&4Essentials Config Reloaded&F]");
